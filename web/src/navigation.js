...
export const NAV_SECTIONS = [
    ...
    items: [
      {
        ...
        label: 'Home',
        icon: Home,
        description: 'Historical dataset analytics, platform benchmarks and product tour',
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/anomalies-excess',
        label: 'Anomalies & Excess',
        icon: TriangleAlert,
        description: 'Isolation Forest outliers with possible root-cause explanations',
        keywords: 'anomaly outlier isolation forest excess usage spike',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        to: '/predictor',
        label: 'Consumption & Cost Predictor',
        icon: Wallet,
        description: 'Random Forest next-day kWh estimate with flat-rate cost projection',
        keywords: 'predict forecast ml random forest 30 days consumption cost',
      },
      {
        to: '/advisor',
        label: 'Energy Advisor',
        icon: Sparkles,
        description: 'Rule-based recommendations from your appliance usage',
...
export const COMMAND_ACTIONS = [
  ...
  {
    id: 'advisor-actions',
    label: 'See Energy Advisor recommendations',
    to: '/advisor',
    icon: Sparkles,
