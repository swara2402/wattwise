...
export function PredictorPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Forecasting"
        title="Consumption & Cost Predictor"
        subtitle="Provide 30 days of history, get a next-day kWh estimate with the model's own error bar. The projected cost is a flat-rate calculation: predicted kWh × tariff × days."
        action={
