...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Isolation Forest identifies statistically unusual consumption days and flags them with possible explanations. Unusual patterns may reflect appliance changes, occupancy shifts, or other factors.',
  },
  {
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <Badge tone={health.online ? 'brand' : 'warn'} className="normal-case">
                <span
                  ...
                  aria-hidden="true"
                />
                {health.online ? 'Dataset-backed data' : 'Snapshot data'}
              </Badge>
            </div>
